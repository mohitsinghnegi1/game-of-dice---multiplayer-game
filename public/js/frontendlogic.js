(function (app) {
    ...
    function addButtonEvents() {
        ...
        $('#quickplay').bind('click', onQuickPlayGame);
    ...
    function onCreateGame() {
        ...
        console.log("emitting create game request", {'name': userData.userName, 'score': 0, 'state': 'ready', 'type': 'room-admin', '_id': userData._id});
    ...
    function onQuickPlayGame() {
        $("#start").hide();
        $("#leaveGameBtn").show();
        var userData = JSON.parse(sessionStorage.getItem('userData'));
        console.log("adgadg userData", userData);
        console.log("emitting quick play game request", {'name': userData.userName, 'score': 0, 'state': 'ready', 'type': 'room-admin', '_id': userData._id});
        socket.emit('quickplay', {'name': userData.userName, 'score': 0, 'state': 'ready', 'type': 'room-admin', '_id': userData._id});
        console.log("emitted quickplay game request");
    }
